...
module.exports = {
    mode: 'production', // mode key tells webpack wheteer it should apply some optimizations
    ...
    devtool: 'none', // defines how source maps are generated, helps us with debugging when we run our original code
    module: {
        rules: [
            {
